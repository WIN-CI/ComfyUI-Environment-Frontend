...
export function CustomAlertDialog({ title, description, cancelText, actionText, onAction, children, open, onOpenChange, variant = "destructive", loading = false }: CustomAlertDialogProps) {
  return (
